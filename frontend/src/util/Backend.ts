...
export class Backend {
    ...
    public static async addItem(itemId: string, sellingPrice: number, costPrice: number, grouping: string) {
        ...
        return await axios.post(Backend.BASE + endpoint, data)
            .then(() => true)
            .catch(() => false);
    }
    ...
    public static async getItemList(): Promise<Item[] | null> {
        ...
        return await axios.get(Backend.BASE + endpoint)
            .then((res) => res.data)
            .catch(() => null);
    }
    ...
    public static async addMember(userId: string, displayName: string, attribute: string) {
    ...
    public static async deleteChat(id: string) {
        ...
        // TODO 成否判定
        return await axios.get(Backend.BASE + endpoint, data)
            .then(() => true)
            .catch(() => false);
    }
