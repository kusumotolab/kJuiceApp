...
public class SellingOfEachMemberInHalfYear {
  ...
  //  */
  // private Map<String, SellingOfEachMonthPerPerson> sellingOfEachMemberInHalfYear = new
  // HashMap<>();
  ...
  // private void setSellingOfAllUser(HistoryList historyList, MemberList memberList, Calendar
  // today) {
  ...
  //         monthAsYYYYMM, new SellingOfEachMonthPerPerson(historyList, memberList, thatday));
  //   }
  // }
